...
from models import pose_dla_dcn
from tracker import matching
from .basetrack import BaseTrack, TrackState
from utils.utils import ctdet_post_process, _tranpose_and_gather_feat, load_model
...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        with torch.no_grad():
            ...
            reg = output['reg']
            dets, inds = mot_decode(hm, wh, reg=reg, ltrb=True, K=self.opt.K)
