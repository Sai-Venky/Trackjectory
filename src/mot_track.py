...
def eval_seq(opt, save_dir='/Users/ecom-v.ramesh/Documents/Personal/2020/DL/Trackjectory/output', frame_rate=30):
    
    dataloader = LoadImages('/Users/ecom-v.ramesh/Documents/Personal/2020/DL/Trackjectory/data/kabadi')
